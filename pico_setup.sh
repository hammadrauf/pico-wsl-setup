#!/bin/bash
# Configures WSL (Windows 10/11) for the Raspberry Pi Pico and Visual Studio Code.
# Based on the official raspberrypi/pico-setup.sh script at https://raw.githubusercontent.com/raspberrypi/pico-setup/master/pico_setup.sh 
# Official Pico C/C++ Development page: https://www.raspberrypi.com/documentation/microcontrollers/c_sdk.html
#
